...
public class AdapterCorreo extends RecyclerView.Adapter<AdapterCorreo.ViewHolder> {
    private LayoutInflater inflador; Correo[] datos; Context micontext; public AdapterCorreo(Context context, Correo[] datos) {
        this.datos=	datos;
        micontext=context;
    ...
    @Override
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) { View v = inflador.inflate(R.layout.list_item_correo, parent, false); return new ViewHolder(v);
    }
    @Override
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        public TextView titulo, subtitutlo; ViewHolder(View itemView) {
            super(itemView);
